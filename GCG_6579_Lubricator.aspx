...
<body onload="Javascript:CustomTrans.Ctrl1.focus();">
    ...
    <%  Dim uDBFns As New DBFns
        Dim sError = "", sTXID, sUSER, sLID, sLabel, sCtrlType, sStyle, sDefaultText, sName, sFieldLength, sOptions(), sTemp As String
        ...
        cmdDBComm.CommandText = "select * from GCG_6579_CUSTOM_LBLS where TXID='" + sTXID + "' and USER_ID='" + sUSER + "' Order by OrderNo, Label"
    %>
    <div>
        <table align="center">
            ...
            <tr><td>
                <table  align="center">
                    ...
                    %>          <tr>
                                ...
                                %>      <td><%=sLabel%></td>
				                        <td><%Response.Write("<INPUT class=""TextBox"" type=""text"" id=" + sName + " name=" + sName + " value=""" + sDefaultText + """ maxlength=" + sFieldLength + ">")%></td>
                                <%  End If%>
